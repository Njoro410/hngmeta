...
const Banner = () => {
  return (
    <div className="w-full h-[70px] flex flex-row justify-center items-center md:gap-[264px] py-[10px] md:px-[100px] bg-[#A02279]">
      <div>
        <img className="p-5 md:p-0 md:w-[90rem] lg:w-full" src={token} alt="" />
      </div>
      <div>
      <img className="p-5 md:p-0 md:w-[90rem] lg:w-full" src={meta} alt="" />
      </div>
      <div>
        <img className="p-5 md:p-0 md:w-[90rem] lg:w-full" src={sea} alt="" />
      </div>
    </div>
  );
};
